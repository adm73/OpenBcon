...
export const dashboardGroups: DashboardGroup[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        intro:
          'This listing page shows every discovery record available in the workspace by default.',
        entries: makeEntries('Discovery', 'funding match'),
      },
      {
        id: 'quick-build',
        label: 'Quick Build',
      ...
      },
      {
        ...
        intro:
          'This page reopens the latest strategic report so users can review, edit, export, or continue the generated output.',
        entries: makeEntries('Strategic Reports', 'report output'),
      },
    ],
  },
  {
