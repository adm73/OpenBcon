...
const environmentSchema = z.object({
  ...
  // Production deployments expose this only on the private Compose network.
  // The token is generated by deploy.sh and is never accepted from clients.
  OPENBCON_UPDATE_AGENT_URL: z.string().url().optional(),
